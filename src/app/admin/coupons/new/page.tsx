  ...
  return (
    <div>
      <h1 className="mb-6 font-heading text-2xl font-extrabold tracking-tight">
        New <span className="text-crimson">Coupon</span>
      </h1>
      ...
      <form onSubmit={handleSubmit} className="max-w-lg space-y-5">
        <div>
          ...
          <input name="code" value={form.code} onChange={handleChange} className="input-field w-full uppercase" placeholder="SUMMER20" required />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <label className="text-xs text-dark-text-secondary">Active on creation</label>
        </div>
